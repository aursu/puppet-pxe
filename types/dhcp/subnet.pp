type Pxe::Dhcp::Subnet = Struct[{
  ...
  Optional[range]               => Pxe::Dhcp::Range,        # see "The range statement" in https://kb.isc.org/docs/isc-dhcp-41-manual-pages-dhcpdconf#REFERENCE:%20DECLARATIONS
